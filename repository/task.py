...
class TaskRepository:
    ...
    def create_task(self, task: TaskCreateSchema, user_id: int) -> int:   # до этого вместо 'Task' были 'Tasks', а еще он возвращал возвращал None вместо int
...
def Tet_Tasks_repository() -> TaskRepository:
